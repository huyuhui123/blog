<template>
  <el-card>
    ...
    <div class="me-author-description">
      ...
      <span><i class="me-icon-job"></i> &nbsp;java初级</span>
    </div>
...
<script>
  export default {
    ...
    data() {
      return {
        qq: {title: 'QQ', message: '1'},
        bilibili: {
          title: '哔哩哔哩',
          message: '2'//<a target="_blank" href="https://space.bilibili.com/473844125">https://space.bilibili.com/473844125</a>
        }
      }
    },
    methods: {
